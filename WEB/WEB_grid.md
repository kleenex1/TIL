...
![GRID](./%EC%8A%A4%ED%81%AC%EB%A6%B0%EC%83%B7/%ED%99%94%EB%A9%B4%20%EC%BA%A1%EC%B2%98%202022-09-07%20135725.png)
...
<body>
  <div class="container">
    ...
    <h2>breakpoint</h2>
    <div class="row my-3">
      <div class="col-12 col-sm-8 col-md-6 col-lg-4"><div class="box">col-5</div></div>
    </div>
    <!-- 총 6개를 배치할건데,
    한 줄에...
    가장 작은 화면 : 한개
